...
const SaveCards = (props: any) => {
    ...
    const paymentMutation = trpc.nodepayment.stripePay.useMutation()
    ...
    return (
        <Box className='relative' >
            ...
            {!_.isEmpty(cardList.data) ? <>
                ...
                <Box className="min-h-[100px] border-b">
                ...
                <Group position='apart' className=' mt-6'>
                    ...
                    <Button onClick={() => {
                        paymentMutation.mutate({ paymentId: activeId, backupMethod: false, cartId: props.cartId }, {
